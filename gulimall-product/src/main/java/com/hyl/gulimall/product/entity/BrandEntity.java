package com.hyl.gulimall.product.entity;
...
import com.hyl.common.validator.group.ListValue;
...
public class BrandEntity implements Serializable {
	...
	@URL(message = "logo必须是一个合法url地址",groups = {UpdateGroup.class,AddGroup.class})
	private String logo;
	/**
	 * 介绍
	 */
	 ...
	 * 显示状态[0-不显示；1-显示]
	 */
	@NotNull(groups = {AddGroup.class, UpdateGroupStatus.class})
	@ListValue(vals={0,1},groups = {AddGroup.class, UpdateGroupStatus.class})
