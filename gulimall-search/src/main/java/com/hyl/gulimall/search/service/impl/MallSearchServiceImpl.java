...
import com.hyl.gulimall.search.feign.ProductFeignService;
import com.hyl.gulimall.search.service.MallSearchService;
import com.hyl.gulimall.search.vo.AttrResponseVo;
import com.hyl.gulimall.search.vo.BrandVo;
...
public class MallSearchServiceImpl implements MallSearchService {
    ...
    private SearchRequest buildSearchRequest(SearchParamVo paramVo) {
        ...
        if (!StringUtils.isEmpty(paramVo.getSkuPrice())) {
            ...
            //注意String.split("_")方法在第一个字符为"_"时s[0]为空串
...
//                String replace = paramVo.get_queryString().replace("&attrs=" + attr, "");
                //这里可以不用硬编码
